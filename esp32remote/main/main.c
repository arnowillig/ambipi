...
"#rb{position:absolute;top:.45em;left:.7em;font-size:.85em;font-weight:bold;padding:.25em .7em;margin:0}"
...
"<button class=off id=rb onclick=\"if(confirm('ESP32 neu starten?'))go2('reboot')\">\xE2\x9F\xB3 Reboot</button>"
