...
".box{position:relative;background:#1b1b1b;border:1px solid #333;border-radius:14px;padding:.55em .55em;margin:.5em 0;text-align:center}"
...
".row{display:flex;gap:.4em;margin-top:.3em}.row button{flex:1;margin:0;padding:.55em .4em}"
".dpad{display:inline-grid;grid-template-columns:repeat(3,64px);grid-template-areas:'. up .' 'lt ok rt' '. dn .';gap:.3em;margin:.35em auto}.dpad button{margin:0;width:64px;padding:.5em 0}"
...
"<div class=box style='padding-top:1.7em'>"
