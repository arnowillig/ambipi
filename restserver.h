...
public:
	...
	void setHdrSat(const Rest::Request &request, Http::ResponseWriter response);
	void getHdrSat(const Rest::Request &request, Http::ResponseWriter response);
	void setHdrTint(const Rest::Request &request, Http::ResponseWriter response);
	void getHdrTint(const Rest::Request &request, Http::ResponseWriter response);
	void setHdrTemp(const Rest::Request &request, Http::ResponseWriter response);
	void getHdrTemp(const Rest::Request &request, Http::ResponseWriter response);
	...
	void beamerVolUp(const Rest::Request &request, Http::ResponseWriter response);
